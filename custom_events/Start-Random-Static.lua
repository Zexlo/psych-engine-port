...
function onCreate()
    makeAnimatedLuaSprite('StaticRand', 'screenstaticBG', 0, 0); -- init static sprite 
    addAnimationByPrefix('StaticRand', 'rando', 'STATIC', staticSpeed, false); -- init animation
    addLuaSprite('StaticRand', true); -- add sprite
setProperty('StaticRand.alpha', 0);	
