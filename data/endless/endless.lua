...
function onCreate()
	...
	makeAnimatedLuaSprite('Majinbop', 'endless/majin FG2', -850, 550); --majing FG2 is the filename in mod/images so change it to your image (it needs to have an XML for its anims)
