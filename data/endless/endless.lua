...
function onCreate()
	...
	makeAnimatedLuaSprite('Majinbop', 'endless/majin FG2', -1200, 350); --majing FG2 is the filename in mod/images so change it to your image (it needs to have an XML for its anims)
...
function onStepHit()
	...
	setProperty('Majinbop.scale.x', getProperty('Majinbop.scale.x') + 0.0); -- if you change the value it will grow in size without stopping so DO NOT edit the value (idk if removing this will break it im too lazy
