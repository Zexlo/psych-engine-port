function onCreate()
	...
	makeLuaSprite('Runstage', 'YCR/P2sky', -450, -300); -- X,Y pos
        setScrollFactor('P2sky', 0, 0);
	    
    makeLuaSprite('RunT', 'YCR/P2trees', -450, -300); -- X,Y pos
    setScrollFactor('P2trees', 0.9, 0.9);
    
    	makeLuaSprite('RunG', 'YCR/P2ground', -450, 450); -- X,Y pos
